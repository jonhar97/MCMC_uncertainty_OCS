...
# ============================================================================
# PATHS — Loblolly pine (Pinus taeda)
# ============================================================================

BASE_PATH  = "C:\\Users\\JOAH\\OneDrive - Skogforsk\\Documents\\Projekt\\Optimum contribution selection\\TaedaPineData/"
SAVE_PATH  = joinpath(BASE_PATH, "results_G_926")
FIG_PATH   = joinpath(BASE_PATH, "Figures")
mkpath(FIG_PATH)

# Files sit directly in results_G_926, no subfolder — point straight at it
ACTUAL_DIR_PINE = SAVE_PATH
println("Diagnosing chain in: $ACTUAL_DIR_PINE")

# ============================================================================
# HELPER FUNCTIONS (unchanged from spruce/QTL-MAS script)
# ============================================================================
...
for (save_dir, label, trait_names) in [
        (ACTUAL_DIR_PINE, "LoblollyPine926", ["HT6", "DBH6", "WDN4", "GV6"])
    ]
    ...
    if var_path != ""
        ...
        println("  genetic variance chain not found — check filenames listed above")
    end
end