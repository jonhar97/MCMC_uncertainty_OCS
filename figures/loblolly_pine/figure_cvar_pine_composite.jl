...
REQUIREMENTS:
  Run cvar_ocs_forest_trees.jl  → cvar_ocs_frontier_pine.csv
  Run cvar_frontier_elbow.jl    → frontier_metrics_with_elbow.csv
  Run forest_robustness_analysis_2.jl → robustness_analysis_pine.csv
                                      → evaluation_gains_pine.csv

USAGE:
  include("figure_cvar_pine_composite.jl")
...
THETA         = 0.03
CVAR_LABEL    = "CVaR_a0.95_mu1.5"   # update when re-run with mu=1.25
...
ROBUSTNESS_FILE= joinpath(SAVE_DIR, "robustness_analysis_pine.csv")    # from forest_robustness_analysis_2.jl
EVAL_FILE      = joinpath(SAVE_DIR, "evaluation_gains_pine.csv")       # from forest_robustness_analysis_2.jl

# Output
OUTPUT_PDF = joinpath(FIG_DIR, "Figure_CVaR_pine.pdf")
OUTPUT_PNG = joinpath(FIG_DIR, "Figure_CVaR_pine.png")
...
println("""
======================================================================
COMPOSITE FIGURE SCRIPT — CVaR-OCS Loblolly Pine (Pinus taeda)
======================================================================
Panels:
  (a) Gain-tail-risk efficiency frontier with elbow markers
...
Requires pre-computed CSVs from:
  ...
  - forest_robustness_analysis_2.jl -> robustness_analysis_pine.csv
                                    -> evaluation_gains_pine.csv
...
Output:
  Figures/Figure_CVaR_pine.pdf
  Figures/Figure_CVaR_pine.png
======================================================================
""")
