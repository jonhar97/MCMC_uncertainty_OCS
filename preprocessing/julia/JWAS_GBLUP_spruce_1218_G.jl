...
phenofile  = dataset("C:\\Users\\joah\\OneDrive - Skogforsk\\Documents\\Projekt\\Optimum contribution selection\\NorwaySpruceData\\Save\\JWAS_phenotypes_1218.txt") # C:\Users\joah\OneDrive - Skogforsk\Documents\Projekt\Optimum contribution selection\NorwaySpruceData

#phenofile  = dataset("C:\\Users\\joah\\OneDrive - Skogforsk\\Documents\\Projekt\\Metafounder\\Rcode\\Data\\phenotypes_861_taeda_upd.txt") # C:\Users\joah\OneDrive - Skogforsk\Documents\Projekt\Optimum contribution selection\NorwaySpruceData

#pedfile    = dataset("C:\\Users\\joah\\\OneDrive - Skogforsk\\Documents\\Projekt\\Optimum contribution selection\\NorwaySpruceData\\")
#pedfile    = dataset("C:\\Users\\joah\\OneDrive - Skogforsk\\Documents\\Projekt\\Optimum contribution selection\\NorwaySpruceData\\Save\\pedigree_H_5525.txt")
genofile   = dataset("C:\\Users\\joah\\OneDrive - Skogforsk\\Documents\\Projekt\\Optimum contribution selection\\NorwaySpruceData\\Save\\JWAS_G_1218_tuned.txt")

#genofile   = dataset("C:\\Users\\joah\\OneDrive - Skogforsk\\Documents\\Projekt\\Metafounder\\Rcode\\Data\\Amat_861_taeda_upd.txt")

phenotypes = CSV.read(phenofile,DataFrame,delim = ',',header=true,missingstrings=["NA"])
#pedigree   = get_pedigree(pedfile,separator=",",header=true);
#pedigree   = get_pedigree(pedfile,separator=",",header=true);
genotypes  = get_genotypes(genofile,separator=',',method="GBLUP",header=false, rowID=true);
first(phenotypes,5)


# Step 3: Transform the levels in Sprant17
#phenotypes.Sprant17 = replace(phenotypes.Sprant17, 3 => 4, 2 => 3, 1 => 2, 0 => 1, 9 => 5)
#phenotypes.Lev17 = replace(phenotypes.Lev17, 1 => 2, 0 => 1)
# Verify the transformation
println(unique(phenotypes.Sprant17))
# Step 3: Build Model Equations

#model_equation  ="y1 = intercept + x1 + x2 + x2*x3 + ID + dam + genotypes"
############## traits
## Hjd_17,Hjd_07,Sprant_17,Htv_17,Vit_07
model_equation  ="Hjd17 = intercept + Trial + Trial_Ruta + genotypes
                  Hjd7 = intercept + Trial + Trial_Ruta + genotypes 
                  Sprant17 = intercept + Trial + Trial_Ruta + genotypes
                  Htv17 = intercept + Trial + Trial_Ruta + genotypes"  # Trial*Family_id + 
model = build_model(model_equation);

# Step 4: Set Factors or Covariates
#set_random(model,"Trial");

# Step 5: Set Random or Fixed Effects
#set_random(model,"Trial_Family");
set_random(model,"Trial_Ruta");
#set_random(model,"Ruta");
#set_random(model,"Family_id");
#set_random(model,"genotypes");
#set_random(model,"ID",pedigree);

# Step 6: Run Analysis
out=runMCMC(model,phenotypes,chain_length=1000);
print(out["heritability"])
# Step 7: Check Accuruacy

# Step 8: save output for downstream analysis
out[]
#######################
...
trait_names = ["Hjd17", "Hjd7", "Sprant17", "Htv17"]
...
# Extract genetic variance-covariance components from JWAS output
genetic_var_df = out["genetic_variance"]
trait_names = ["Hjd17", "Hjd7", "Sprant17", "Htv17", "Lev17"]
n_traits = length(trait_names)
...
try
    ...
    savefig(p1, plot_path * "genetic_correlation_heatmap_G_1218.png")
    savefig(p2, plot_path * "genetic_correlation_barplot_G_1218.png")
    savefig(p3, plot_path * "genetic_correlation_ci_G_1218.png")
    savefig(p4, plot_path * "genetic_correlation_magnitude_G_1218.png")
    savefig(p5, plot_path * "correlation_vs_se_G_1218.png")
    savefig(p6, plot_path * "heritabilities_G_1218.png")
    savefig(combined_plot, plot_path * "genetic_correlations_combined_G_1218.png")
    savefig(p1, plot_path * "genetic_correlation_heatmap_G_1218.pdf")
    savefig(p2, plot_path * "genetic_correlation_barplot_G_1218.pdf")
    savefig(p3, plot_path * "genetic_correlation_ci_G_1218.pdf")
    savefig(p4, plot_path * "genetic_correlation_magnitude_G_1218.pdf")
    savefig(p5, plot_path * "correlation_vs_se_G_1218.pdf")
    savefig(p6, plot_path * "heritabilities_G_1218.pdf")
    savefig(combined_plot, plot_path * "genetic_correlations_combined_G_1218.pdf")
    
    println("Plots saved:")
    println("  - Heatmap: genetic_correlation_heatmap_G_1218.png")
    println("  - Bar plot with SE: genetic_correlation_barplot_G_1218.png") 
    println("  - Confidence intervals: genetic_correlation_ci_G_1218.png")
    println("  - Magnitude plot: genetic_correlation_magnitude_G_1218.png")
    println("  - Correlation vs SE: correlation_vs_se_G_1218.png")
    println("  - Heritabilities: heritabilities_G_1218.png")
    println("  - Combined plot: genetic_correlations_combined_G_1218.png")
...
# Save results
output_path = "C:\\Users\\joah\\OneDrive - Skogforsk\\Documents\\Projekt\\Optimum contribution selection\\NorwaySpruceData\\Save\\heritability_results_G_1218.csv"
CSV.write(output_path, heritability_df)
println("\nResults saved to 'heritability_results_G_1218.csv'")