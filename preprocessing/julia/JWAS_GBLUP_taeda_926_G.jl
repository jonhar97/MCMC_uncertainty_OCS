...
# Save results
output_path = "C:\\Users\\joah\\OneDrive - Skogforsk\\Documents\\Projekt\\Optimum contribution selection\\TaedaPineData\\Save\\genetic_correlations_results_G_926.csv"
CSV.write(output_path, final_results)
println("\nResults saved to 'genetic_correlations_results_G_926.csv'")
...
# Save results
output_path = "C:\\Users\\joah\\OneDrive - Skogforsk\\Documents\\Projekt\\Optimum contribution selection\\TaedaPineData\\Save\\heritability_results_G_926.csv"
CSV.write(output_path, heritability_df)
println("\nResults saved to 'heritability_results_G_926.csv'")